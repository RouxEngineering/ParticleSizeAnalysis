    ...
    if list_of_imagepaths:
        ...
        for image_path in list_of_imagepaths:
            if 'scale.png' in image_path:
                ...
                absolute_image_path = image_directory + scale_image_path 
                absolute_results_path = os.path.splitext(results_directory + scale_image_path)[0]+'_results.csv'
                absolute_output_path = os.path.splitext(output_directory + scale_image_path )[0]+'_processedimage.png'
